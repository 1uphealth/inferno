...
module Inferno
  module Sequence
    class USCore310PulseOximetrySequence < SequenceBase
      ...
      description 'Verify support for the server capabilities required by the US Core Pulse Oximetry Profile.'

      details %(
        # Background

        The US Core #{title} sequence verifies that the system under test is able to provide correct responses
        for Observation queries.  These queries must contain resources conforming to US Core Pulse Oximetry Profile as specified
      ...
      test :validate_resources do
        ...
        bindings = USCore310PulseOximetrySequenceDefinitions::BINDINGS
