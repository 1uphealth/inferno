...
module Inferno
  module Sequence
    class USCore310PediatricBmiForAgeSequence < SequenceBase
      ...
      description 'Verify support for the server capabilities required by the US Core Pediatric BMI for Age Observation Profile.'

      details %(
        # Background

        The US Core #{title} sequence verifies that the system under test is able to provide correct responses
        for Observation queries.  These queries must contain resources conforming to US Core Pediatric BMI for Age Observation Profile as specified
      ...
      test :validate_resources do
        ...
        bindings = USCore310PediatricBmiForAgeSequenceDefinitions::BINDINGS
