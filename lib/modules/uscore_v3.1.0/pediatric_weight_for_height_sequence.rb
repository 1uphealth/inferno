...
module Inferno
  module Sequence
    class USCore310PediatricWeightForHeightSequence < SequenceBase
      ...
      description 'Verify support for the server capabilities required by the US Core Pediatric Weight for Height Observation Profile.'

      details %(
        # Background

        The US Core #{title} sequence verifies that the system under test is able to provide correct responses
        for Observation queries.  These queries must contain resources conforming to US Core Pediatric Weight for Height Observation Profile as specified
      ...
      test :validate_resources do
        ...
        bindings = USCore310PediatricWeightForHeightSequenceDefinitions::BINDINGS
