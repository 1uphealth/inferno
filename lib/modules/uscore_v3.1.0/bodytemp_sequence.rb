...
module Inferno
  module Sequence
    class USCore310BodytempSequence < SequenceBase
      ...
      description 'Verify support for the server capabilities required by the Observation Body Temperature Profile.'

      details %(
        # Background

        The US Core #{title} sequence verifies that the system under test is able to provide correct responses
        for Observation queries.  These queries must contain resources conforming to Observation Body Temperature Profile as specified
        ...
        ## Profile Validation
        Each resource returned from the first search is expected to conform to the [Observation Body Temperature Profile](http://hl7.org/fhir/StructureDefinition/bodytemp).
      ...
      test :validate_resources do
        ...
        bindings = USCore310BodytempSequenceDefinitions::BINDINGS
