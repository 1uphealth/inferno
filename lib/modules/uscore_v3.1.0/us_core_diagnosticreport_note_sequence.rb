  ...
  module Sequence
    class USCore310DiagnosticreportNoteSequence < SequenceBase
      ...
      test 'Server returns Provenance resources from DiagnosticReport search by patient + category + _revIncludes: Provenance:target' do
        ...
        save_delayed_sequence_references(provenance_results, USCore310DiagnosticreportNoteSequenceDefinitions::DELAYED_REFERENCES)
      ...
      test :validate_resources do
        ...
        bindings = USCore310DiagnosticreportNoteSequenceDefinitions::BINDINGS
